<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- Deliverables (full CRUD lands in M2d) --}}
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-6 py-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400">Deliverable CRUD lands in M2d</span>
                </div>
                <div class="p-6 text-sm text-gray-500 dark:text-gray-400">
                    @if ($project->deliverables->isEmpty())
                        No deliverables yet.
                    @else
                        {{ $project->deliverables->count() }} deliverable(s). UI coming next milestone.
                    @endif
                </div>
            </div>
        </div>
